...
const App: React.FC = () => {
  ...
  // --- Refs ---
  // 关键修改 1: 初始为 null，稍后在组件体内进行严格初始化
  const audioRef = useRef<HTMLAudioElement | null>(null);
  
  // 关键修改 2: 确保 Audio 对象创建时立即获得 crossOrigin 属性
  // 这比在 useEffect 中设置要早，能有效解决移动端 Safari 的安全策略问题
  ...
  // --- Initialization ---
  useEffect(() => {
    // 这里不需要再设置 crossOrigin 了，上面已经处理了
    loadLibrary();
